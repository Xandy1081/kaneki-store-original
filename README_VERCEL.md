...
- `PUBLIC_BASE_URL` (ex.: `https://seu-projeto.vercel.app`)
- `DISCORD_CLIENT_ID` e `DISCORD_CLIENT_SECRET` se quiser Discord.

## 3. Google Cloud
Para um domínio de produção `https://seu-projeto.vercel.app`:

**Origens JavaScript autorizadas**
`https://seu-projeto.vercel.app`

**URIs de redirecionamento autorizados**
`https://seu-projeto.vercel.app/api/oauth/google/callback`
