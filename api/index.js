...
async function oauthCallback(req,res,provider){
  ...
  res.setHeader('Set-Cookie',[`kaneki_session=${token}; Path=/; HttpOnly; Secure; SameSite=Lax; Max-Age=2592000`,`oauth_state=; Path=/; HttpOnly; Secure; SameSite=Lax; Max-Age=0`]);
